  ...
  const guideSections = [
    {
      ...
      description:
        "Halaman dashboard utama untuk memantau status operasional secara keseluruhan.",
      features: [
    ...
    },
    {
      ...
      description:
        "Prediksi tingkat kedatangan dan kepadatan pasien 24 jam ke depan.",
      features: [
    ...
    },
    {
      ...
      title: "Shift Swap",
      description:
        "Sistem manajemen pertukaran jadwal (tukar shift) yang didukung analisis keamanan AI.",
      features: [
    ...
    },
    {
      ...
      description:
        "Fasilitas 'Stress-Testing' untuk menguji ketahanan rumah sakit terhadap krisis ekstrim.",
      features: [
    ...
    },
    {
      ...
      description:
        "Halaman laporan strategis khusus untuk Kepala Rumah Sakit atau Direktur.",
      features: [
    ...
    },
    {
      ...
      description:
        "Hub yang menunjukkan status keterhubungan dengan infrastruktur RS eksisting.",
      features: [
  ...
  return (
    <div className="min-h-screen pb-12 bg-slate-50/50">
      <Header
        ...
        subtitle="Dokumentasi Interaktif HEAL AI Command Center"
      />
          ...
          <div className="relative z-10 flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-2 tracking-tight">
                Selamat Datang di HEAL Shift AI
              </h2>
              <p className="text-blue-50 max-w-2xl leading-relaxed">
                HEAL (Hermina Employee Allocation Logic) dirancang tidak hanya
                untuk membuat jadwal dinas, tetapi juga mencegah BURNOUT,
                mengoptimalkan beban klinis, dan memastikan kualitas NCH
                (Nursing Care Hours) tetap optimal dengan kecerdasan buatan.
              </p>
            </div>
          </div>
        </div>
              ...
              {guideSections.map((section) => {
                ...
                return (
                  <AccordionItem
                    value={section.id}
                    key={section.id}
                    className="border-b border-slate-100 last:border-0 px-6"
                  >
